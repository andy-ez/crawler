...
* As a default a limit of 100 is set on the total number of visited urls. This parameter can be changed by passing in a number as the second arguement after the url, e.g:
